...
"""
    ...
    This file contains the implementation of the MetaFormer model.
    
    **************************************************************
    Paper: https://arxiv.org/abs/2210.13452v3
    GitHub: https://github.com/sail-sg/metaformer
    **************************************************************
    
    Im only use the CAFormer model from original papers
...
if __name__ == '__main__':
    ...
    print("MetaFormer models are implemented in the original paper and the official repository.")